...
import { UpdateCommand, UpdateArgs as UpdateCommandArgs } from "../commands";
import { UpdateParamsBuilder } from "../commands/update/update-params-builder";
...
export class Octommit {
  ...
  update() {
    return new Repository({ githubToken: this.githubToken });
  }
}
